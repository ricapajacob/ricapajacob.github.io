...
var timeInterval; $(document).ready(function(){$(":input").attr("autocomplete","off");$(":input").attr("spellcheck",false);paintOk();randomSort();timeInterval=setInterval("paintTab()",1000);
