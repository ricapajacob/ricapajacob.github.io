...
nameItem="#audioAct"+indexTXT.toString();if ($(nameItem).length !=0){$("#playSound").css("cursor","pointer");$("#playSound").click(function (e) {playAct();});}
...
contexto.fillStyle=colorSele;var gcolorSele=colorSele;colorSele="#A426D9";paintBubble(contexto,0,0,canvas.width-10, canvas.height-3,xPoint,10);colorSele=gcolorSele;
...
function playAct(){var nameItem="#audioAct"+indexTXT.toString();if ($(nameItem).length !=0){nameItem=nameItem.substring(1);document.getElementById(nameItem).play();}}
